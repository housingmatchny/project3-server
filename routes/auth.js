  ...
  Tenant.findOne({ email })
    ...
    .then((foundTenant) => {
      ...
      if (passwordCorrect) {
        ...
        const { _id, email, name, image, about, boroughPreference, maxPrice, beds, baths, householdSize, pets, program, programAmt, creditScore, annualIncome, employmentStatus, moveInDate, viewingAvailability, reviews, likes, listings } = foundTenant;
